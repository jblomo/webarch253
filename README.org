* Web Architecture 253 :slide:
  + Description :: Understanding the web technologies from user-facing (HTML, CSS) to underlying (TCP/IP).  At the end of the course students will have an overview of what happens between typing an address in a browser through interacting with the web page.  We'll leverage industry accepted technologies to implement a simple web app.
...
|------+----------+--------+--------------------|
| 2012-08-25 | [[http://www.w3.org/DesignIssues/TimBook-old/History.html][A Brief History of the Web]] & [[http://www.scientificamerican.com/article.cfm?id=long-live-the-web&print=true][Long Live the Web]] | [[file:20120820-Intro/20120820-Intro.html][Intro]] & [[file:20120820-Intro/20120824-Browsers.html][Browsers & HW1]] | See Browser slides |
| Aug 24 | N/A | Introduction & Web Browsers | Account Signups & Comparisons |
